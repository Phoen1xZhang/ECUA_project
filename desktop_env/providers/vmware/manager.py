...
def _install_vm(vm_name, vms_dir, downloaded_file_name, os_type, original_vm_name="Ubuntu"):
    ...
    def __download_and_unzip_vm():
        ...
        print("Files have been successfully extracted to the directory: " + str(os.path.join(vms_dir, vm_name)))

    vm_path = os.path.join('/Users/zhangtongke/OSWorld',vms_dir, vm_name, vm_name + ".vmx")
    print(vm_path)
