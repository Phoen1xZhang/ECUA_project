...
def config() -> argparse.Namespace:
    ...
    # environment config
    parser.add_argument("--path_to_vm", type=str, default="/Users/zhangtongke/OSWorld/vmware_vm_data/Ubuntu0/Ubuntu0.vmx")
    parser.add_argument(
    ...
    parser.add_argument(
        "--action_space", type=str, default="computer_13", help="Action type"
    )
    parser.add_argument(
        "--observation_type",
